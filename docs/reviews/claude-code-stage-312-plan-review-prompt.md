# Claude Code Stage 312 Plan Review Prompt

You are reviewing `/home/ubuntu/fashion-radar` on branch `main`.

Review the Stage 312 design and implementation plan:

- `docs/superpowers/specs/2026-07-06-stage-312-row-one-saved-article-coverage-design.md`
- `docs/superpowers/plans/2026-07-06-stage-312-row-one-saved-article-coverage-plan.md`
...
4. Report Critical and Important findings first with file/section references.
...
8. Keep the whole response under 120 lines.
