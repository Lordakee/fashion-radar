Review the Stage 259 release-finalization docs changes for Fashion Radar as
the local opencode fallback reviewer.
...
- docs/reviews/claude-code-stage-259-code-review.md
