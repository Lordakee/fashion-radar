# opencode Stage 301 Plan Review Prompt
...
Claude Code review may be unavailable. If it is unavailable, act as the fallback reviewer. Use GLM 5.2 max judgment and identify Critical/Important issues before implementation.
