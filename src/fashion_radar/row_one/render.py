...
def _daily_digest_payload(
    ...
    return {
        ...
        "briefing_topics": _briefing_topics_payload(stories),
        "blocks": [
...
def _briefing_topics_payload(stories: list[dict[str, object]]) -> list[dict[str, object]]:
    ...
    for story_index, story in enumerate(stories):
        ...
        for topic_type, reference in _topic_references_for_story(story):
            ...
            topic = topics.setdefault(
                topic_key,
                _empty_briefing_topic(topic_type, name, story_index, reference),
            )
            ...
            topic["cards"].append(_content_card_payload(story))
