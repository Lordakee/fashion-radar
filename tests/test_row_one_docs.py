...
def test_row_one_docs_describe_stage_370_daily_local_article_intelligence_brief_boundary() -> None:
    expected = (
        "Stage 370 adds generated-site only Daily Local Article Intelligence Brief "
        "inside `index.html` between the Daily Local Theme Summary Strip and Saved "
        "Article Content Organization; it reuses current-edition stories, "
        "current-edition saved local article sidecars, Stage 369 local article "
        "intelligence briefs, generated local article page routes, existing saved "
        "local paragraphs, existing local article brief sections, existing local "
        "article content sections, existing item references, existing item-level "
        "paragraph indices, existing content-section anchors, and existing paragraph "
        "anchors to summarize today's saved articles into a homepage opening read, "
        "entity lanes, article cards, and same-site reader routes without changing "
        "app-facing contracts; it does not create "
        "`data/daily-local-article-intelligence-brief.json`, does not create "
        "`data/local-article-intelligence-brief.json`, does not create "
        "`data/article-intelligence-brief.json`, does not create "
        "`daily-local-article-intelligence-brief.html`, does not create "
        "`local-article-intelligence-brief.html`, does not create "
        "`article-intelligence-brief.html`, does not create new article-source "
        "sidecars, does not create new route families, does not alter "
        "`articles/index.html`, `articles/<story-id>.html`, or detail pages, does "
        "not publish full articles on the homepage, does not add outbound article "
    ...
    for path in (README, ROW_ONE_DOC):
        ...
        stage_369_pos = text.index(
            "Stage 369 adds generated-site only Local Article Intelligence Brief"
        )
        assert stage_370_pos < stage_369_pos
        stage = _normalized(text[stage_370_pos:stage_369_pos])
        for stale_phrase in (
            "creates data/daily-local-article-intelligence-brief.json",
            "writes data/daily-local-article-intelligence-brief.json",
            "creates data/local-article-intelligence-brief.json",
            "writes data/local-article-intelligence-brief.json",
            "creates data/article-intelligence-brief.json",
            "writes data/article-intelligence-brief.json",
            "creates daily-local-article-intelligence-brief.html",
            "writes daily-local-article-intelligence-brief.html",
            "creates local-article-intelligence-brief.html",
            "writes local-article-intelligence-brief.html",
            "creates article-intelligence-brief.html",
            "writes article-intelligence-brief.html",
            "creates `data/daily-local-article-intelligence-brief.json`",
            "writes `data/daily-local-article-intelligence-brief.json`",
            "creates `data/local-article-intelligence-brief.json`",
            "writes `data/local-article-intelligence-brief.json`",
...
def test_row_one_docs_describe_stage_369_local_article_intelligence_brief_boundary() -> None:
    expected = _normalized(
        "Stage 369 adds generated-site only Local Article Intelligence Brief "
        "inside `articles/<story-id>.html` between the Local Article Body "
        "Organizer and the saved local article body; it reuses current-edition "
        "saved local article sidecars, existing saved local paragraphs, existing "
        "local article brief sections, existing local article content sections, "
        "existing item references, existing item-level paragraph indices, "
        "existing content-section anchors, and existing paragraph anchors to "
        "summarize each saved article body into an opening signal, entity lanes, "
        "paragraph evidence trail, and local reader route without "
        "changing app-facing contracts; it does not create "
        "`data/local-article-intelligence-brief.json`, does not create "
        "`data/article-intelligence-brief.json`, does not create "
        "`data/intelligence-brief.json`, does not create "
        "`local-article-intelligence-brief.html`, does not create "
        "`article-intelligence-brief.html`, does not create "
        "`intelligence-brief.html`, does not create new article-source "
        "sidecars, does not create new route families, does not alter "
        "`index.html`, `articles/index.html`, or detail pages, does not "
        "publish full articles on the homepage or library index, does not add "
        "outbound article URLs as primary navigation, and does not change "
        "row-one-app/v7, row-one-manifest/v1, row-one-runtime/v1, schemas, "
        "JSON artifacts, source collection, fetching, matching, extraction, "
        "scoring, ranking, LLM, connector, scheduling, deployment, market "
        "grouping, domestic/international classification, analytics, "
    ...
    for path in (README, ROW_ONE_DOC):
        normalized = _normalized(_read(path))
        assert expected in normalized
        stage_369_pos = normalized.index(
            "stage 369 adds generated-site only local article intelligence brief"
        )
        stage_368_pos = normalized.index(
            "stage 368 adds generated-site only local article body organizer"
        )
        assert stage_369_pos < stage_368_pos
        stage = normalized[stage_369_pos:stage_368_pos]
        for stale_phrase in (
            "creates data/local-article-intelligence-brief.json",
            "writes data/local-article-intelligence-brief.json",
            "creates data/article-intelligence-brief.json",
            "writes data/article-intelligence-brief.json",
            "creates data/intelligence-brief.json",
            "writes data/intelligence-brief.json",
            "creates local-article-intelligence-brief.html",
            "writes local-article-intelligence-brief.html",
            "creates article-intelligence-brief.html",
            "writes article-intelligence-brief.html",
            "creates intelligence-brief.html",
            "writes intelligence-brief.html",
            "creates `data/local-article-intelligence-brief.json`",
            "writes `data/local-article-intelligence-brief.json`",
            "creates `data/article-intelligence-brief.json`",
            "writes `data/article-intelligence-brief.json`",
...
def test_row_one_docs_describe_stage_381_related_read_connection_brief_boundary() -> None:
    paragraph = (
        ...
        "contracts; it does not create "
        "`data/saved-local-article-related-read-connection-brief.json`, "
    ...
    for text in (readme, docs):
        ...
        for stale_phrase in (
            ...
            "adds deployment",
            "adds market grouping",
            "adds domestic/international classification",
            "adds analytics",
            "adds personalization",
            "adds recommendation",
            "adds demand proof",
...
def test_row_one_docs_describe_stage_382_local_article_synthesis_brief_boundary() -> None:
    paragraph = (
        "Stage 382 adds generated-site-only Local Article Synthesis Brief copy inside "
        "`articles/<story-id>.html` after the existing Local Article Intelligence Brief "
        "and before the saved local article body; it reuses existing ROW ONE story fields, "
        "current-edition saved local article sidecars, existing brief sections, existing "
        "content-section text, existing saved paragraphs, existing generated local article "
        "page routes, and existing safe same-page content-section and paragraph anchors to "
        "give readers a compact narrative so-what interpretation without changing "
        "app-facing contracts; it does not create "
        "`data/local-article-synthesis-brief.json`, does not create "
        "`data/saved-local-article-synthesis-brief.json`, does not create "
        "`data/article-synthesis-brief.json`, does not create "
        "`local-article-synthesis-brief.html`, does not create "
        "`saved-local-article-synthesis-brief.html`, does not create "
        "`article-synthesis-brief.html`, does not create new article-source sidecars, "
        "does not create new route families, does not alter `index.html`, "
        "`articles/index.html`, or detail pages, does not publish full articles outside "
        "existing local article pages, does not add outbound article URLs as primary "
        "navigation, and does not change row-one-app/v7, row-one-manifest/v1, "
        "row-one-runtime/v1, schemas, generated JSON artifacts, source collection, "
        "fetching, scraping, matching, extraction, scoring, ranking, LLM, connector, scheduling, "
        "deployment, market grouping, domestic/international classification, analytics, "
        "personalization, recommendation, demand proof, coverage verification, or "
        "compliance-review behavior."
    )
    ...
    for text in (readme, docs):
        assert paragraph in text
        assert text.index(paragraph) < text.index("Stage 381 adds")

        stage_382_slice = text[text.index(paragraph) : text.index("Stage 381 adds")]
        normalized = _normalized(stage_382_slice)
        for stale_phrase in (
            "creates data/local-article-synthesis-brief.json",
            "writes data/local-article-synthesis-brief.json",
            "creates data/saved-local-article-synthesis-brief.json",
            "writes data/saved-local-article-synthesis-brief.json",
            "creates data/article-synthesis-brief.json",
            "writes data/article-synthesis-brief.json",
            "creates local-article-synthesis-brief.html",
            "writes local-article-synthesis-brief.html",
            "creates saved-local-article-synthesis-brief.html",
            "writes saved-local-article-synthesis-brief.html",
            "creates article-synthesis-brief.html",
            "writes article-synthesis-brief.html",
            "creates new article-source sidecars",
            "creates new route families",
            "adds new routes",
            "alters index.html",
...
def test_row_one_docs_describe_stage_383_daily_local_synthesis_brief_boundary() -> None:
    paragraph = (
        "Stage 383 adds generated-site-only Daily Local Synthesis Brief copy on the "
        "ROW ONE homepage inside `index.html` after the existing Daily Local Article "
        "Intelligence Brief and before the Daily Local Saved Article Organizer; it "
        "reuses current-edition ROW ONE stories, current-edition saved local article "
        "sidecars, existing generated local article page routes, and Stage 382 "
        "article-page synthesis fields to give readers a compact homepage-only "
        "cross-article synthesis without changing app-facing contracts; it does not "
        "create `data/daily-local-synthesis-brief.json`, does not create "
        "`data/local-synthesis-brief.json`, does not create "
        "`data/daily-synthesis-brief.json`, does not create "
        "`daily-local-synthesis-brief.html`, does not create "
        "`local-synthesis-brief.html`, does not create "
        "`daily-synthesis-brief.html`, does not create new article-source sidecars, "
        "does not create new route families, does not alter `articles/index.html`, "
        "`articles/<story-id>.html`, or detail pages, does not publish full articles "
        "on the homepage, does not add outbound article URLs as primary navigation, "
        "and does not change row-one-app/v7, row-one-manifest/v1, row-one-runtime/v1, "
        "schemas, generated JSON artifacts, source collection, fetching, scraping, "
        "matching, extraction, scoring, ranking, LLM, connector, scheduling, "
        "deployment, market grouping, domestic/international classification, analytics, "
        "personalization, recommendation, demand proof, coverage verification, or "
        "compliance-review behavior."
    ...
    for text in (readme, docs):
        assert paragraph in text
        assert text.index(paragraph) < text.index("Stage 382 adds")

        stage_383_slice = text[text.index(paragraph) : text.index("Stage 382 adds")]
        normalized = _normalized(stage_383_slice)
        for stale_phrase in (
            "creates data/daily-local-synthesis-brief.json",
            "writes data/daily-local-synthesis-brief.json",
            "creates data/local-synthesis-brief.json",
            "writes data/local-synthesis-brief.json",
            "creates data/daily-synthesis-brief.json",
            "writes data/daily-synthesis-brief.json",
            "creates daily-local-synthesis-brief.html",
            "writes daily-local-synthesis-brief.html",
            "creates local-synthesis-brief.html",
            "writes local-synthesis-brief.html",
            "creates daily-synthesis-brief.html",
            "writes daily-synthesis-brief.html",
            "creates new article-source sidecars",
            "creates new route families",
            "adds new routes",
            "alters articles/index.html",
...
def test_row_one_docs_describe_stage_386_daily_saved_text_takeaways_boundary() -> None:
    paragraph = (
        "Stage 386 adds a generated-site-only Daily Saved Text Takeaways section "
        "on the ROW ONE homepage in `index.html`; it reuses current-edition ROW ONE "
        "stories, current-edition saved local article sidecars, existing generated "
        "local article page routes, saved paragraphs, content sections, and local "
        "article anchors to show short capped saved-text snippets grouped for reading "
        "without changing app-facing contracts; it does not create "
        "`data/daily-local-saved-text-takeaways.json`, does not create "
        "`data/daily-saved-text-takeaways.json`, does not create "
        "`daily-local-saved-text-takeaways.html`, does not create "
        "`daily-saved-text-takeaways.html`, does not create new article-source "
        "sidecars, does not create new route families, does not alter "
        "`articles/index.html`, `articles/<story-id>.html`, detail pages, "
        "`data/edition.json`, `data/manifest.json`, or `data/runtime.json`, does not "
        "publish full article bodies on the homepage, and does not change "
        "row-one-app/v7, row-one-manifest/v1, row-one-runtime/v1, schemas, generated "
        "JSON artifacts, source collection, fetching, scraping, matching, extraction, "
        "scoring, ranking, LLM, connector, scheduling, deployment, analytics, "
        "personalization, recommendation, demand proof, coverage verification, or "
        "compliance-review behavior."
    )
    ...
    for text in (readme, docs):
        ...
        stage_386_slice = text[
            text.index(paragraph) : text.index(
                "Stage 385 adds a generated-site-only Daily Local Synthesis Evidence Trail"
            )
        ]
        normalized = _normalized(stage_386_slice)
        for stale_phrase in (
            "creates data/daily-local-saved-text-takeaways.json",
            "writes data/daily-local-saved-text-takeaways.json",
            "creates data/daily-saved-text-takeaways.json",
            "writes data/daily-saved-text-takeaways.json",
            "creates daily-local-saved-text-takeaways.html",
            "writes daily-local-saved-text-takeaways.html",
            "creates daily-saved-text-takeaways.html",
            "writes daily-saved-text-takeaways.html",
            "creates new article-source sidecars",
            "writes new article-source sidecars",
            "creates new route families",
            "writes new route families",
...
def test_row_one_docs_describe_stage_384_daily_local_synthesis_quality_boundary() -> None:
    paragraph = (
        "Stage 384 hardens the generated-site-only Daily Local Synthesis Brief "
        "presentation on the ROW ONE homepage by omitting blank thesis paragraphs, "
        "tightening the existing homepage-only renderer sentinel, and adding long-text "
        "wrapping for synthesis card titles, source chips, and saved-article route "
        "labels; it reuses the Stage 383 homepage section, current render model, "
        "existing CSS, and existing generated local article page routes while adding "
        "presentation-focused regression coverage without changing app-facing "
        "contracts; it does not create "
        "`data/daily-local-synthesis-quality.json`, does not create "
        "`data/daily-synthesis-quality.json`, does not create "
        "`daily-local-synthesis-quality.html`, does not create "
        "`daily-synthesis-quality.html`, does not create new article-source "
        "sidecars, does not create new route families, does not alter "
        "`articles/index.html`, `articles/<story-id>.html`, or detail pages, does "
        "not publish full articles on the homepage, does not add outbound article URLs "
        "as primary navigation, and does not change row-one-app/v7, "
        "row-one-manifest/v1, row-one-runtime/v1, schemas, generated JSON artifacts, "
        "source collection, fetching, scraping, matching, extraction, scoring, "
        "ranking, LLM, connector, scheduling, deployment, market grouping, "
        "domestic/international classification, analytics, personalization, "
        "recommendation, demand proof, coverage verification, or compliance-review "
        "behavior."
    )
    readme = _read(README)
    docs = _read(ROW_ONE_DOC)
    ...
    for text in (readme, docs):
        assert paragraph in text
        assert text.index(paragraph) < text.index(
            "Stage 383 adds generated-site-only Daily Local Synthesis Brief"
        )

        stage_384_slice = text[
            text.index(paragraph) : text.index(
                "Stage 383 adds generated-site-only Daily Local Synthesis Brief"
            )
        ]
        normalized = _normalized(stage_384_slice)
        for stale_phrase in (
            "creates data/daily-local-synthesis-quality.json",
            "writes data/daily-local-synthesis-quality.json",
            "creates data/daily-synthesis-quality.json",
            "writes data/daily-synthesis-quality.json",
            "creates daily-local-synthesis-quality.html",
            "writes daily-local-synthesis-quality.html",
            "creates daily-synthesis-quality.html",
            "writes daily-synthesis-quality.html",
            "creates new article-source sidecars",
            "creates new route families",
            "adds new routes",
            "creates new routes",
